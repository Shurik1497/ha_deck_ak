...
void HdButton::render_() {
    ...
    lv_obj_set_style_bg_color(button_, lv_color_hex(bg_color_), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(button_, 225, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(button_, lv_color_hex(bg_color_), LV_PART_MAIN | LV_STATE_DISABLED);
    lv_obj_set_style_bg_opa(button_, 5, LV_PART_MAIN | LV_STATE_DISABLED);
    lv_obj_set_style_text_color(button_, lv_color_hex(color_), LV_PART_MAIN | LV_STATE_DISABLED);
