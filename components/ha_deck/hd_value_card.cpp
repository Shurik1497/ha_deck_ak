...
void HdValueCard::render_() {
    ...
    lv_obj_set_style_bg_opa(lv_main_, 225, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(lv_value_, LV_FONT_MONTSERRAT_48, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(text_container, 48);
    ...
    if (!text_.empty())
    {
        ...
        lv_obj_set_style_text_font(text_lbl, &Font24, LV_PART_MAIN | LV_STATE_DEFAULT);
    }
